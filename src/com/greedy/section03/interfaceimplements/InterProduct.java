...
/*인터페이스에서 인터페이스를 상속받을 시 extends를 사용하여 다중 상속이 가능하다.*/
...
//	public InterProduct() {}
	...
	/*상수 필드만을 가질 수 있기 떄문에 모든 필드는 묵시적으로 public static final의 의미를 가진다.*/
	int MIN_NUM = 10;
	
	/*인터페이스는 구현부가 있는 non-static 메소드를 가질 수 없다.*/
//	public void nonStaticMethod() {}
	
	/*하지만 static 메소드는 작성이 가능해진다. (JDK 1.8 부터 추가된 기능)*/
